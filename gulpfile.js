...
function vendorGroup() {
    ...
    ]).pipe(dest('./public/vendor/jqcloud2'));

    //jqBootstrapValidation Custom lib
    var jqBootstrapValidation = src([
        ...
        .pipe(
            purgecss({
                ...
                whitelist: [
                    ...
                    'dropdown-menu', 'dropdown-menu-right', 'dropdown-menu-left', 'position-static', 'dropleft', 'dropright', 'dropup', 'dropdown-item', 'dropdown-menu',
                    'modal-open', 'modal-backdrop', 'modal-scrollbar-measure', 'modal-dialog-scrollable'
                ],
